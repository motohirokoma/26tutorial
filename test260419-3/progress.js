...
const STORAGE_KEY = 'test260419-3-tutorial-progress';
const STREAK_KEY = 'test260419-3-tutorial-streak';
const TUTORIAL_SLUG = 'test260419-3';

const CHAPTERS = [
  { id: '01', title: 'Hooksとは', hours: 0.42, phase: 'basics' },
  { id: '02', title: 'Hookイベント一覧', hours: 0.58, phase: 'basics' },
  { id: '03', title: 'settings.jsonの書き方', hours: 0.5, phase: 'basics' },
  { id: '04', title: 'Hookレシピ集', hours: 0.67, phase: 'basics' },
  { id: '05', title: '実践：Lint/Prettier をPreToolUseで', hours: 0.5, phase: 'practice' },
  { id: '06', title: '実践：Stop時にサマリ', hours: 0.5, phase: 'practice' },
  { id: '07', title: 'トラブルシュート & セキュリティ', hours: 0.42, phase: 'practice' },
  { id: '08', title: '最終演習：頻出作業3つをHook化', hours: 0.5, phase: 'practice' },
];

const TOTAL_HOURS = 4;

const CHAPTER_FILES = {
  '01': '01-hooks-overview.html',
  '02': '02-hook-events.html',
  '03': '03-settings-syntax.html',
  '04': '04-recipes.html',
  '05': '05-lint-prettier.html',
  '06': '06-stop-summary.html',
  '07': '07-troubleshoot-security.html',
