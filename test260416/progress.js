 ...
 * and syncs to Firestore (tutorials/logical-thinking/users/{uid}) when signed in.
 */
import {
  auth,
  db,
...
const STORAGE_KEY = 'logical-thinking-tutorial-progress';
const STREAK_KEY = 'logical-thinking-tutorial-streak';
const TUTORIAL_SLUG = 'logical-thinking';

const CHAPTERS = [
  { id: '01', title: 'ロジカルシンキングとは', hours: 0.5, phase: 'basics' },
  { id: '02', title: 'MECE', hours: 1, phase: 'basics' },
  { id: '03', title: '演繹法と帰納法', hours: 0.5, phase: 'basics' },
  { id: '04', title: 'ロジックツリー', hours: 1, phase: 'core' },
  { id: '05', title: 'イシューツリー', hours: 1, phase: 'core' },
  { id: '06', title: 'ピラミッド構造', hours: 1, phase: 'core' },
  { id: '07', title: '仮説思考と論点思考', hours: 1, phase: 'advanced' },
  { id: '08', title: '戦略フレームワーク', hours: 1, phase: 'advanced' },
  { id: '09', title: '最終演習問題', hours: 1, phase: 'capstone' },
];
...
const CHAPTER_FILES = {
  '01': '01-intro.html',
  '02': '02-mece.html',
  '03': '03-deduction-induction.html',
  '04': '04-logic-tree.html',
  '05': '05-issue-tree.html',
  '06': '06-pyramid.html',
  '07': '07-hypothesis.html',
  '08': '08-strategy-frameworks.html',
  '09': '09-capstone.html',
};
