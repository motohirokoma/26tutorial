...
const STORAGE_KEY = 'test260419-2-tutorial-progress';
const STREAK_KEY = 'test260419-2-tutorial-streak';
const TUTORIAL_SLUG = 'test260419-2';

const CHAPTERS = [
  { id: '01', title: 'MCPとは', hours: 0.42, phase: 'basics' },
  { id: '02', title: 'Claude CodeにMCPを追加', hours: 0.67, phase: 'basics' },
  { id: '03', title: '公式MCPサーバー一覧', hours: 0.5, phase: 'basics' },
  { id: '04', title: '実践：GitHub MCP', hours: 0.67, phase: 'practice' },
  { id: '05', title: '実践：Filesystem・他MCP', hours: 0.5, phase: 'practice' },
  { id: '06', title: 'カスタムMCPサーバー入門', hours: 0.67, phase: 'practice' },
  { id: '07', title: 'MCPのトラブルシュート', hours: 0.33, phase: 'practice' },
  { id: '08', title: '最終演習：主戦場ツールをMCP化', hours: 0.42, phase: 'practice' },
];

const TOTAL_HOURS = 4;

const CHAPTER_FILES = {
  '01': '01-mcp-overview.html',
  '02': '02-mcp-config.html',
  '03': '03-official-servers.html',
  '04': '04-github-mcp.html',
  '05': '05-filesystem-others.html',
  '06': '06-custom-mcp.html',
  '07': '07-troubleshoot.html',
