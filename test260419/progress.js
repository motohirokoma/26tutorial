...
const STORAGE_KEY = 'test260419-tutorial-progress';
const STREAK_KEY = 'test260419-tutorial-streak';
const TUTORIAL_SLUG = 'test260419';

const CHAPTERS = [
  { id: '01', title: 'Subagentsとは', hours: 0.5, phase: 'basics' },
  { id: '02', title: 'Agentツールの基本', hours: 0.5, phase: 'basics' },
  { id: '03', title: 'Agentタイプの使い分け', hours: 0.5, phase: 'basics' },
  { id: '04', title: '並列実行の設計', hours: 0.5, phase: 'basics' },
  { id: '05', title: 'Subagentプロンプト術', hours: 0.75, phase: 'practice' },
  { id: '06', title: '実践：リサーチ5並列', hours: 0.5, phase: 'practice' },
  { id: '07', title: '実践：コードレビュー分割', hours: 0.5, phase: 'practice' },
  { id: '08', title: '最終演習：3つ組み込む', hours: 0.58, phase: 'practice' },
];

const TOTAL_HOURS = 4;

const CHAPTER_FILES = {
  '01': '01-subagents-overview.html',
  '02': '02-agent-tool-basics.html',
  '03': '03-agent-types.html',
  '04': '04-parallel-design.html',
  '05': '05-prompt-craft.html',
  '06': '06-research-parallel.html',
  '07': '07-review-parallel.html',
