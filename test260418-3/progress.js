 ...
 * and syncs to Firestore (tutorials/{{SLUG}}/users/{uid}) when signed in.
 * Merges local and cloud state on sign-in (union of completions, max streak).
 *
 * Placeholders replaced per tutorial:
 *   {{SLUG}}            — tutorial slug (Firestore path segment)
 *   {{CHAPTERS_ARRAY}}  — CHAPTERS const body
 *   {{TOTAL_HOURS}}     — TOTAL_HOURS const value
 *   {{CHAPTER_FILES}}   — CHAPTER_FILES const body
 *   {{STORAGE_KEY}}     — localStorage key prefix (must be unique per tutorial)
 *   {{STREAK_KEY}}      — localStorage key for streak
 */
import {
  auth,
  db,
...
const STORAGE_KEY = 'test260418-3-tutorial-progress';
const STREAK_KEY = 'test260418-3-tutorial-streak';
const TUTORIAL_SLUG = 'test260418-3';

const CHAPTERS = [
  { id: '01', title: 'AI時代に "君の" ビジネス基礎が必要な理由', hours: 0.5, phase: 'basics' },
  { id: '02', title: '学生から社会人へ — マインドセットの転換', hours: 0.5, phase: 'basics' },
  { id: '03', title: 'ビジネスマナーの基本', hours: 0.75, phase: 'basics' },
  { id: '04', title: '報連相 + 質問力 — 信頼の通貨', hours: 0.5, phase: 'basics' },
  { id: '05', title: 'ビジネスメール — AI時代の作法', hours: 0.75, phase: 'core' },
  { id: '06', title: '電話応対 — Z世代の鬼門', hours: 0.5, phase: 'core' },
  { id: '07', title: '会議と議事録', hours: 0.5, phase: 'core' },
  { id: '08', title: 'ロジカルシンキング入門', hours: 1, phase: 'core' },
  { id: '09', title: 'ビジネスドキュメント作成', hours: 0.5, phase: 'core' },
  { id: '10', title: '上司・先輩との関係づくり', hours: 0.5, phase: 'advanced' },
  { id: '11', title: 'タイムマネジメント・PDCA', hours: 0.5, phase: 'advanced' },
  { id: '12', title: '日本の商習慣β — 接待・贈答・冠婚葬祭', hours: 0.75, phase: 'advanced' },
  { id: '13', title: '最終演習問題 — 君だけの "ビジネス基礎" を実装する', hours: 0.75, phase: 'advanced' },
];

const TOTAL_HOURS = 8;

const CHAPTER_FILES = {
  '01': '01-ai-era-value.html',
  '02': '02-student-to-member.html',
  '03': '03-business-manners.html',
  '04': '04-horenso-questions.html',
  '05': '05-email.html',
  '06': '06-phone.html',
  '07': '07-meeting.html',
  '08': '08-logical-thinking.html',
  '09': '09-documents.html',
  '10': '10-relationships.html',
  '11': '11-time-pdca.html',
  '12': '12-japanese-customs.html',
  '13': '13-final-exercise.html',
};
