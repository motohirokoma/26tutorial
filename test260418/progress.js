...
const CHAPTERS = [
  ...
  { id: '02', title: '給与・税金・社会保険の基本', hours: 1, phase: 'basics' },
  { id: '03', title: '公的年金の仕組み', hours: 0.75, phase: 'basics' },
  { id: '04', title: '家計管理とキャッシュフロー', hours: 0.75, phase: 'basics' },
  { id: '05', title: '銀行・預貯金と金利', hours: 0.5, phase: 'core' },
  { id: '06', title: '投資商品の基礎：債券・株式・投資信託', hours: 1, phase: 'core' },
  { id: '07', title: 'NISA・iDeCo：非課税制度を使いこなす', hours: 1, phase: 'core' },
  { id: '08', title: '生命保険の考え方', hours: 0.75, phase: 'core' },
  { id: '09', title: '損害保険の考え方', hours: 0.75, phase: 'core' },
  { id: '10', title: '住宅ローンと不動産', hours: 1, phase: 'advanced' },
  { id: '11', title: '確定申告・所得控除の基本', hours: 0.75, phase: 'advanced' },
  { id: '12', title: '相続の基本知識', hours: 0.5, phase: 'advanced' },
  { id: '13', title: '最終演習問題：あなたのライフプラン', hours: 0.75, phase: 'advanced' },
];
...
const CHAPTER_FILES = {
  '01': '01-intro.html',
  '02': '02-salary-tax-social.html',
  '03': '03-pension.html',
  '04': '04-household-cashflow.html',
  '05': '05-bank-deposits.html',
  '06': '06-investment-basics.html',
  '07': '07-nisa-ideco.html',
  '08': '08-life-insurance.html',
  '09': '09-non-life-insurance.html',
  '10': '10-mortgage-real-estate.html',
  '11': '11-tax-filing.html',
  '12': '12-inheritance.html',
