 ...
 * and syncs to Firestore (tutorials/test260416-2/users/{uid}) when signed in.
...
const STORAGE_KEY = 'test260416-2-tutorial-progress';
const STREAK_KEY = 'test260416-2-tutorial-streak';
const TUTORIAL_SLUG = 'test260416-2';

const CHAPTERS = [
  { id: '01', title: 'LLMとは何か', hours: 0.5, phase: 'basics' },
  { id: '02', title: '言葉を数字に変える', hours: 0.5, phase: 'basics' },
  { id: '03', title: '次単語予測', hours: 0.5, phase: 'basics' },
  { id: '04', title: 'Transformer', hours: 0.75, phase: 'deepdive' },
  { id: '05', title: 'LLMはどう学ぶのか', hours: 0.75, phase: 'deepdive' },
  { id: '06', title: '能力・限界・未来', hours: 0.5, phase: 'deepdive' },
  { id: '07', title: '最終演習問題', hours: 0.5, phase: 'deepdive' },
];

const TOTAL_HOURS = 4;

const CHAPTER_FILES = {
  '01': '01-what-is-llm.html',
  '02': '02-tokens-embeddings.html',
  '03': '03-next-token-prediction.html',
  '04': '04-transformer.html',
  '05': '05-training.html',
  '06': '06-capabilities-limits.html',
  '07': '07-final-exercise.html',
};
