...
const STORAGE_KEY = 'test260419-4-tutorial-progress';
const STREAK_KEY = 'test260419-4-tutorial-streak';
const TUTORIAL_SLUG = 'test260419-4';

const CHAPTERS = [
  { id: '01', title: 'Scheduled Tasks & Loop とは', hours: 0.42, phase: 'basics' },
  { id: '02', title: '/loop スキル', hours: 0.5, phase: 'basics' },
  { id: '03', title: 'Scheduled Tasks (CronCreate)', hours: 0.67, phase: 'basics' },
  { id: '04', title: '放置運用プロンプトのコツ', hours: 0.5, phase: 'basics' },
  { id: '05', title: '実践：5分ごとCIチェック', hours: 0.5, phase: 'practice' },
  { id: '06', title: '実践：毎朝PRサマリ通知', hours: 0.5, phase: 'practice' },
  { id: '07', title: '実践：長時間タスクを /loop で自走', hours: 0.5, phase: 'practice' },
  { id: '08', title: '最終演習：定期タスク3つ自動化', hours: 0.42, phase: 'practice' },
];

const TOTAL_HOURS = 4;

const CHAPTER_FILES = {
  '01': '01-schedule-loop-overview.html',
  '02': '02-loop-skill.html',
  '03': '03-cron-schedule.html',
  '04': '04-prompt-design.html',
  '05': '05-ci-polling.html',
  '06': '06-daily-pr-summary.html',
  '07': '07-long-running-loop.html',
