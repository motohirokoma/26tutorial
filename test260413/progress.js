...
const STORAGE_KEY = 'test260413-tutorial-progress';
const STREAK_KEY = 'test260413-tutorial-streak';
const TUTORIAL_SLUG = 'test260413';

const CHAPTERS = [
  { id: '01', title: 'ようこそ&セットアップ再確認', hours: 0.5, phase: 'basics' },
  { id: '02', title: '対話の原則：上手な頼み方', hours: 0.75, phase: 'basics' },
  { id: '03', title: 'ファイル操作ツール4つ', hours: 1.0, phase: 'basics' },
  { id: '04', title: 'Bashツールと安全な使い方', hours: 0.75, phase: 'basics' },
  { id: '05', title: 'TodoWriteで作業管理', hours: 0.5, phase: 'basics' },
  { id: '06', title: 'CLAUDE.mdで環境を教える', hours: 0.75, phase: 'basics' },
  { id: '07', title: 'Git × Claude Code 基本ワークフロー', hours: 0.75, phase: 'basics' },
  { id: '08', title: 'プロンプト設計の型', hours: 1.0, phase: 'core' },
  { id: '09', title: 'コードレビュー依頼の作法', hours: 0.75, phase: 'core' },
  { id: '10', title: '既存コードの改修ワークフロー', hours: 1.0, phase: 'core' },
  { id: '11', title: 'テスト駆動での依頼', hours: 1.0, phase: 'core' },
  { id: '12', title: 'デバッグ：バグを直させる頼み方', hours: 0.75, phase: 'core' },
  { id: '13', title: 'Planモードの使い所', hours: 0.5, phase: 'core' },
  { id: '14', title: 'コンテキスト管理（/compact /clear memory）', hours: 0.75, phase: 'core' },
  { id: '15', title: 'Web検索・取得の活用', hours: 0.5, phase: 'core' },
  { id: '16', title: 'Subagentsで並列思考', hours: 1.0, phase: 'advanced' },
  { id: '17', title: 'MCPで主戦場ツールと繋ぐ', hours: 1.0, phase: 'advanced' },
  { id: '18', title: 'Hooksで自動化', hours: 1.0, phase: 'advanced' },
  { id: '19', title: 'Scheduled Tasks & /loop', hours: 0.75, phase: 'advanced' },
  { id: '20', title: 'Skillsで自分のワークフローを作る', hours: 0.75, phase: 'advanced' },
  { id: '21', title: 'worktreeで安全に実験', hours: 0.5, phase: 'advanced' },
  { id: '22', title: '失敗パターン10：ここで詰まる', hours: 1.0, phase: 'advanced' },
  { id: '23', title: 'Project A：業務自動化ツールを作る', hours: 1.5, phase: 'projects' },
  { id: '24', title: 'Project B：既存コードの大規模リファクタ', hours: 1.5, phase: 'projects' },
  { id: '25', title: 'Project C：ゼロからWebアプリを作ってデプロイ', hours: 1.5, phase: 'projects' },
  { id: '26', title: '最終演習：自社業務を1つClaude Code化', hours: 1.5, phase: 'projects' },
];
...
const CHAPTER_FILES = {
  '01': '01-welcome.html',
  '02': '02-communication-basics.html',
  '03': '03-file-tools.html',
  '04': '04-bash-safety.html',
  '05': '05-todo-management.html',
  '06': '06-claude-md.html',
  '07': '07-git-workflow.html',
  '08': '08-prompt-patterns.html',
  '09': '09-code-review.html',
  '10': '10-refactor-workflow.html',
  '11': '11-tdd-with-claude.html',
  '12': '12-debugging.html',
  '13': '13-plan-mode.html',
  '14': '14-context-management.html',
  '15': '15-web-tools.html',
  '16': '16-subagents-overview.html',
  '17': '17-mcp-overview.html',
  '18': '18-hooks-overview.html',
  '19': '19-schedule-loop.html',
  '20': '20-skills-overview.html',
  '21': '21-worktree.html',
  '22': '22-pitfalls.html',
  '23': '23-project-automation.html',
  '24': '24-project-refactor.html',
  '25': '25-project-webapp.html',
  '26': '26-final-exercise.html',
};
